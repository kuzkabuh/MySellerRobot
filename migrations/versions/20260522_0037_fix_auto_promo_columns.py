...
def upgrade() -> None:
    ...
    cond_cols = {col["name"]: col for col in inspector.get_columns("wb_auto_promotion_conditions")}
    ...
    rec_cols = {
        col["name"]: col for col in inspector.get_columns("wb_auto_promo_price_recommendations")
    }
    ...
    hist_cols = {col["name"]: col for col in inspector.get_columns("wb_price_change_history")}
