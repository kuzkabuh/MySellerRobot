...
def upgrade() -> None:
    ...
    if "wb_product_prices" not in existing_tables:
        op.create_table(
            ...
            sa.Column("currency_code", sa.String(16), nullable=False, server_default=sa.text("'RUB'")),
            ...
            sa.UniqueConstraint("marketplace_account_id", "wb_nm_id", name="uq_wb_product_prices_account_nm"),
        )
        op.create_index("ix_wb_product_prices_account", "wb_product_prices", ["marketplace_account_id"])
