"""Add wb_auto_promotion_conditions, wb_auto_promo_price_recommendations,
and wb_price_change_history tables for auto promotion price control.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(64),
            nullable=False,
            server_default=sa.text("'calculation'"),
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "ix_auto_promo_recs_acct_nm_status",
        "wb_auto_promo_price_recommendations",
        ["marketplace_account_id", "wb_nm_id", "status"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(64),
            nullable=False,
            server_default=sa.text("'auto_promotion'"),
        ),
        sa.Column(
            "source",
            sa.String(64),
