...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_sync_task_runs_triggered_by_user_id", "sync_task_runs", ["triggered_by_user_id"]
    )
    ...
    op.create_index(
        "ix_notification_events_user_status", "notification_events", ["user_id", "status"]
    )
    op.create_index(
        "ix_notification_events_status_created", "notification_events", ["status", "created_at"]
    )
