...
class TestAdminLogsModal:
    ...
    def test_log_entry_with_quotes_in_raw_line(self):
        ...
        entry = LogEntry(
            ...
            raw_line='{"timestamp": "2026-01-01T00:00:00Z", "level": "ERROR", "message": "Test with \\"quotes\\" and newlines\\n"}',
...
class TestSettingsRedirect:
    ...
    def test_settings_low_margin_post_redirects_correctly(self, client):
        ...
        response = client.post("/web/settings/low-margin", data={"threshold": "15"}, follow_redirects=False)
